# Parameter inference of Sinusoidal Waves
 ...
 \tikzset{
    ...
    \draw (4,0) node[data] (z1) {} (4,0) node {$z_1$};
    \draw (4,0.7) node[data] (z2) {} (4,0.7) node {$z_2$};
    \draw (4,1.4) node[data] (z3) {} (4,1.4) node {$z_3$};
    \draw (4,2.45) node[rec] (z4) {} (4,2.45) node {$\vdots$};
    ...
    \draw (2,3.5) node[diamond] (t) {} (2,3.5) node {$\tau$}; 
